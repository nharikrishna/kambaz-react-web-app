...
export default function CourseNavigation() {
    return (
        <div id="wd-courses-navigation" className="wd list-group fs-5 rounded-0">
            <Link to="/Kambaz/Courses/5100/Home" id="wd-course-home-link"
                  className="list-group-item active border border-0">Home</Link><br/>
            <Link to="/Kambaz/Courses/5100/Modules" id="wd-course-modules-link"
                  className="list-group-item text-danger border border-0">Modules
            </Link><br/>
            <Link to="/Kambaz/Courses/5100/Piazza" id="wd-course-piazza-link"
                  className="list-group-item text-danger border border-0">Piazza</Link><br/>
            <Link to="/Kambaz/Courses/5100/Zoom" id="wd-course-zoom-link"
            ...
            <Link to="/Kambaz/Courses/5100/Assignments" id="wd-course-quizzes-link"
                ...
                Assignments</Link><br/>
            <Link to="/Kambaz/Courses/5100/Quizzes" id="wd-course-assignments-link"
                  className="list-group-item text-danger border border-0">Quizzes
            </Link><br/>
            <Link to="/Kambaz/Courses/5100/Grades" id="wd-course-grades-link"
                  className="list-group-item text-danger border border-0">Grades</Link><br/>
            <Link to="/Kambaz/Courses/5100/People" id="wd-course-people-link"
