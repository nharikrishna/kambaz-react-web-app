...
export default function TOC() {
    ...
    return (
        <Nav variant="pills" id="wd-toc">
            ...
            <Nav.Item> <Nav.Link href="https://github.com/nharikrishna/kambaz-react-web-app">Frontend GitHub Link</Nav.Link> </Nav.Item>
            <Nav.Item> <Nav.Link href="https://github.com/nharikrishna/kambaz-node-server-app">Backend GitHub Link</Nav.Link> </Nav.Item>
        </Nav>
    );
}
