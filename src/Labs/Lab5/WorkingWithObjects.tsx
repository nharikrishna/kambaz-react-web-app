...
export default function WorkingWithObjects() {
    ...
    return (
        <div id="wd-working-with-objects">
            ...
            <FormControl id="wd-assignment-title" className="w-auto"
            ...
            <FormControl type="number" id="wd-assignment-score" className="w-auto"
            ...
            <FormControl id="wd-module-name" className="w-auto"
